package br.org.ifsuldeminas.acaocidadania.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.org.ifsuldeminas.acaocidadania.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.org.ifsuldeminas.acaocidadania.repository.UserRepository.USERS_BY_EMAIL_CACHE);
