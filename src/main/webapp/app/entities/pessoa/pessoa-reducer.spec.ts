...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pessoa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PESSOA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PESSOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PESSOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PESSOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PESSOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PESSOA actions', async () => {
      const expectedActions = [
        {
