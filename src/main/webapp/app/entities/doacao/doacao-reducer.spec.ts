...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './doacao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOACAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOACAO actions', async () => {
      const expectedActions = [
        {
