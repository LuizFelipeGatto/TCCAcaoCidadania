...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CESTADESCRICAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CESTADESCRICAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CESTADESCRICAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CESTADESCRICAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CESTADESCRICAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CESTADESCRICAO actions', async () => {
      const expectedActions = [
        {
