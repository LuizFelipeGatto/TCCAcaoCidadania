...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './familia.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAMILIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FAMILIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAMILIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAMILIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAMILIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAMILIA actions', async () => {
      const expectedActions = [
        {
