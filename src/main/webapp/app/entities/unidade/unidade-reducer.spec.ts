...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './unidade.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIDADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIDADE actions', async () => {
      const expectedActions = [
        {
