...
export const Unidade = () => {
  ...
  const totalItems = useAppSelector(state => state.unidade.totalItems);
      ...
      <h2 id="unidade-heading" data-cy="UnidadeHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/unidade/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="acaoCidadaniaApp.unidade.home.createLabel">Create new Unidade</Translate>
          </Link>
        </div>
      </h2>
        ...
        {unidadeList && unidadeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="acaoCidadaniaApp.unidade.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nome')}>
                  <Translate contentKey="acaoCidadaniaApp.unidade.nome">Nome</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('cep')}>
                  <Translate contentKey="acaoCidadaniaApp.unidade.cep">Cep</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('cidade')}>
                  <Translate contentKey="acaoCidadaniaApp.unidade.cidade">Cidade</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/unidade/${unidade.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/unidade/${unidade.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="acaoCidadaniaApp.unidade.home.notFound">No Unidades found</Translate>
            </div>
          )
        )}
      </div>
      {totalItems ? (
        <div className={unidadeList && unidadeList.length > 0 ? '' : 'd-none'}>
